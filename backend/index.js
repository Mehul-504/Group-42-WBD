...
const MONGO_URI = 'mongodb+srv://ayush:ayush@cluster0.i09ljc9.mongodb.net/velvet_homes?retryWrites=true&w=majority'
...
app.post('/customerProfile/upload/:username', uplaod.single('file'), async (req, res) => {
...
// Access the image 
app.use('/customerProfile/images', express.static(path.join(__dirname, "/public/images")));
